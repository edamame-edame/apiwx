"""Type stubs for apiwx.generics_base module.

This module provides type information for BaseGenerics classes (Singleton, 
...
class Singleton(BaseGenerics):
    ...
    Metaclass Replacement:
        When applied as a generic type, Singleton becomes the metaclass
...
class Multiton(BaseGenerics):
    ...
    Metaclass Replacement:
        When applied as a generic type, Multiton becomes the metaclass
        of the target class, not a parent class in the inheritance hierarchy.
    """
